...
type ProfilPengguna struct {
	...
	NamaPengguna       string    `gorm:"column:nama_pengguna;type:varchar(255);foreignKey:IDPengguna;references:IDPengguna;constraint:OnUpdate:CASCADE,OnDelete:SET NULL;not null"`
