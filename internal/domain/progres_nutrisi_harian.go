...
type ProgresNutrisiHarian struct {
	...
	JumlahKonsumsiVitamin    float32 `gorm:"column:jumlah_konsumsi_vitamin;type:float"`
	JumlahKonsumsiMineral    float32 `gorm:"column:jumlah_konsumsi_mineral;type:float"`
