...
func (j *jsonWebToken) GetLoginUser(ctx *gin.Context) (entity.Pengguna, error) {
	user, ok := ctx.Get("user")
	if !ok {
		return entity.Pengguna{}, errors.New("failed to get user")
	}

	return user.(entity.Pengguna), nil
}
